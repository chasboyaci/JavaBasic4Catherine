...
//23:59
		...
		// outer loop is the hours
		// inner loop is the minutes

		for (int hour = 0; hour < 24; hour++) // outer loop
		{
			for (int minute = 0; minute < 60; minute++) // inner loop
			{
				...
				} else if (hour >= 10 && minute < 10) { // case 2
					System.out.println(hour + ":" + "0" + minute);
				} else if (hour < 10 && minute >= 10) { // case 3
