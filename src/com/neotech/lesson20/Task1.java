...
public class Task1 {
	...
	//if I want to allow users to create an object using the default constructor
	//I will create an empty/non-argument constructor
	Task1()
	{
	...
	public static void main(String[] args) {
		...
		Task1 st4 = new Task1(); //does not work if you have not defined a parametized constructor and 
		//have not created a default one as well 
		//yes because we created a default constructor
	}
