 ...
 * 
 * // Class name = new Class name Scanner scanner = new Scanner(System.in);
 * 
 * // CTRL + SHIFT + O
 * 
 * // Declaring strings String text1, text2, text3; int age, year; double
 * salary; boolean isRaining; char gender;
 * 
 * 
 ...
 * //Sabah, Plattsburgh, 30, Male, 150000 text1 = scanner.next(); text2 =
 * scanner.next(); age = scanner.nextInt(); gender =
 * scanner.next().charAt(0);//because in java indexing starts at 0. ex: Male, 0
 * = M salary = scanner.nextDouble(); System.out.println(text1 + " " + text2 +
 * " " + age + " " + gender + " " + salary );
 * 
 * 
 * }
